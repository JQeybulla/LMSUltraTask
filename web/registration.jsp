    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-4">
                <div class="right">
                    <ul>
                        <li><a href="Login.jsp"><button class="btn">Daxil ol</button></a></li>
...
<section id="Registration">
    <div class="col-5">
        <div class="container">
            <div class="regForm">
                <h1><span style="color: #1084da;">Oxuyan</span> Ailəsinə Xoş Gəldiniz!</h1>
                ...
                <form action="register" method="post" class="">
                    ...
                    <input type="text" name="username" id="" placeholder="Istifadeci adi" required>
                    <input type="password" name="password" id="" placeholder="Shifre" required>
                    <input type="password" name="password2" id="" placeholder="Shifreni tesdiqle" required>
                    ...
                    %>
                    <input type="submit" class="btn btn-primary" value="Qeydiyyatdan kec" name="" id="">
                </form>
            </div>
        </div>
