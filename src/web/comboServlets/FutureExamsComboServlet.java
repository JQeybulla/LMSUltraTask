...
@WebServlet("/future-exams-subject-combo")
public class FutureExamsComboServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        String sql = "{ ? = call MYPROJECT.FUTURE_EXAMS_SUBJECT_COMBO() }";
