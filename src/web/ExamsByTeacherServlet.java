...
@WebServlet("/exams-by-teacher")
public class ExamsByTeacherServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        String sql = "{ ? = call MYPROJECT.GET_EXAMS_BY_TEACHER(?) }";
